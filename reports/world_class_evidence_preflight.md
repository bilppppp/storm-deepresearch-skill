...
- supporting evidence ready: `25` / `28`
...
| `supporting-evidence` | `false` | `25 / 28` | Supporting-evidence rows help reviewers audit the packet but do not all need to be copied into artifact_refs. |
