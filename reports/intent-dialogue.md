...
7. What failure would make this skill untrustworthy in practice?
   Why: The answer usually reveals the first evaluation gate worth adding.

## Capture Before Drafting

- Capability sentence: STORM DeepResearch should turn a recurring request into a reliable reusable output without widening the boundary unnecessarily.
