...
| `human-adjudication` | `pending` | `missing` | `human` | 0/7 decisions; pending 7 | Record real A/B choices, reviewer metadata, and blind-review attestation, then regenerate adjudication. |
...
- observed state: `{"model_executed_count": 0, "timing_observed_count": 14, "token_observed_count": 0, "accepted": false}`
