...
Generate final Markdown, HTML, and PDF-ready outputs. Run validation. A full dossier remains in progress until `status.local_delivery_ready` is true; intermediate states are not user-facing completion points.
